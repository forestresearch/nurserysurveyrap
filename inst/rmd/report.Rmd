...
title: 'Nursery Survey: Estimates of sales of improved nursery stock by forest nurseries
  in Great Britain'
output:
  reference_docx: inst/rmd/fr_rep_template.docx
---
...
rbind(table1, table1_sitka_tot, table1_tot) %>%
  ...
  rename(paste0(`Total stock sold in ', planting_year(ref_year), ' (million plants)`) = 2,
         `Improved stock sold in ', planting_year(ref_year), ' (million plants)`) = 3,
...
#### Table 2: Sales of improved nursery stock, Scotland, `r planting_year(ref_year - 10)` to `r planting_year(ref_year)`
...
#### Table 3: Summary table, Great Britain, `r planting_year(ref_year)`
...
rbind(table3, table3_sitka_tot, table3_tot) %>%
  ...
  mutate(volume_total = round_safe(volume_total, 1),
         ...
         pct_improved = round_safe(pct_improved*100, 1)) %>% 
  rename(paste0(`Total stock sold in ', planting_year(ref_year), ' (million plants)` = 2,),
         paste0(`Improved stock sold in ', planting_year(ref_year), ' (million plants)`) = 3,
         `Proportion improved (%)` = 4)  %>%
  gt(rowname_col = "label")
```
...
Figure 2 shows the volume/quantity improved stock sold in Great Britain, from  2005/06 to `r planting_year(ref_year)`
...
#### Table 4: Sales of improved nursery stock, Great Britain, `r planting_year(ref_year - 10)` to `r planting_year(ref_year)`
